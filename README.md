...
There are also commands to migrate the database down (running all migrations) or a specific number of steps (positive to go up, and negative to down) (e.g., after a failed version upgrade):
