...
build-linux-amd64: prebuild
	...
	cp -R db/* $(BUILD_DIR)/linux/amd64/db
	cp -R static/build/es6-unbundled/* $(BUILD_DIR)/linux/amd64/static
...
build-linux-armhf: prebuild
	...
	cp -R db/* $(BUILD_DIR)/linux/armhf/db
	cp -R static/build/es6-unbundled/* $(BUILD_DIR)/linux/armhf/static
...
build-windows-amd64: prebuild
	...
	cp -R db/* $(BUILD_DIR)/windows/amd64/db
	cp -R static/build/es6-unbundled/* $(BUILD_DIR)/windows/amd64/static
