...
//go:generate go run github.com/golang/mock/mockgen@v1.6.0 -destination=../mocks/db/driver.gen.go -package=db . Driver,AppConfigurationDriver,LinkDriver,NoteDriver,UserDriver
